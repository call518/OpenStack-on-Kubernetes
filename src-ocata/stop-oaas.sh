...
kubectl label nodes k8s-node01 controller- compute- nfs-server-
kubectl label nodes k8s-node02 controller- compute-
kubectl label nodes k8s-node03 controller- compute-
kubectl label nodes k8s-node04 network-
kubectl label nodes k8s-node05 network-
